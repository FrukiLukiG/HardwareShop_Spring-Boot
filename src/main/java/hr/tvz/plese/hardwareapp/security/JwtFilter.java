package hr.tvz.plese.hardwareapp.security;

import hr.tvz.plese.hardwareapp.security.service.JwtService;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    private boolean isEndpointAllowingUnauthenticatedAccess(HttpServletRequest request) {
        ...
        return hr.tvz.plese.hardwareapp.security.SecurityConfiguration.UNAUTHENTICATED_ENDPOINTS
                .stream()
