...
import hr.tvz.plese.hardwareapp.security.domain.Authority;
import hr.tvz.plese.hardwareapp.security.domain.Users;
import hr.tvz.plese.hardwareapp.security.user.ApplicationUser;
import hr.tvz.plese.hardwareapp.security.user.UserAuthentication;
...
public class JwtServiceImpl implements JwtService {
    ...
    public String createJwt(Users users) {
        ...
        String authorities = users.getAuthorities()
                .stream()
